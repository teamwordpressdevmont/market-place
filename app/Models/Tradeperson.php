...
class Tradeperson extends Model
{
    ...
    protected $fillable = ['user_id', 'first_name', 'last_name', 'gender', 'phone', 'city', 'postal_code', 'latitude', 'longitude','about_me', 'address', 'portfolio', 'certificate' ,'banner', 'featured'];
