...
//         ['tradeperson_id' => 42, 'category_id' => 13, 'created_at' => now(), 'updated_at' => now()],
...
//         ['tradeperson_id' => 42, 'category_id' => 29, 'created_at' => now(), 'updated_at' => now()],
...
//     DB::table('tradeperson_categories')->insert($tradepersonCategories);
    ...
    $categories = DB::table('categories')->whereNotNull('parent_id')->pluck('id'); 
        ...
        $tradePersons = DB::table('tradepersons')->pluck('id')->toArray();
        
        foreach ($categories as $categoryId) {
            $randomTradePersons = collect($tradePersons)->shuffle()->take(rand(7, 8))->toArray();
        
            foreach ($randomTradePersons as $tradePersonId) {
                DB::table('tradeperson_categories')->insert([
                    'category_id' => $categoryId,
                    'tradeperson_id' => $tradePersonId,
                ]);
            }
        }
