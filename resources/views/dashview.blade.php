...
<div class="mt-5">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 xl:gap-9 gap-5 mt-6">
        <div class="bg-white py-5 xl:px-8 px-5 rounded-xl flex justify-between border border-[#22222233]">
            <div>
                ...
                <p class="text-[#222222] font-bold text-sm">Active Jobs</p>
            </div>
            <div>
        ...
        <div class="bg-white py-5 xl:px-8 px-5 rounded-xl flex justify-between border border-[#22222233]">
            <div>
                ...
                <p class="text-[#222222] font-bold text-sm">pending jobs Post</p>
            </div>
            <div>
                <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-9 mt-8">
        <div class="rounded-xl p-5 bg-white border border-[#22222233]">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-lg font-bold">Recent Jobs</h2>
                <a href="#" class="text-[#ABABAB] text-xs flex items-center font-semibold">View All
                    <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-2">
                    <path d="M13 4.99988L1 4.99988" stroke="#ABABAB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M9.25003 8.75C9.25003 8.75 13 5.98817 13 4.99997C13 4.01177 9.25 1.25 9.25 1.25" stroke="#ABABAB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </a>
            </div>
            <div class="space-y-5">
                <!-- Job Card 1 -->
                <div class="flex items-center rounded-2xl border border-[#22222233] bg-[#F4F4F4] md:flex-row flex-col">
                <img src="http://127.0.0.1:8000/images/job-1.png" alt="Job Image" class="w-35 max-md:w-full h-32 rounded-xl object-cover">
                <div class="py-2 lg:px-5 px-3 flex-1">
                ...
                <div class="flex flex-col md:items-end items-center md:pr-4 pr-0 py-2">
                    <span class="bg-secondary text-white text-xs px-4 py-1 rounded-full md:mb-8 mb-3">Active</span>
                    <a href="#" class="text-[#222222] text-xs flex items-center mt-2 font-semibold">View Job Details
                        <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-2">
                        <path d="M13 4.99982L1 4.99982" stroke="#2B2B2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9.25003 8.75C9.25003 8.75 13 5.98817 13 4.99997C13 4.01177 9.25 1.25 9.25 1.25" stroke="#2B2B2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </a>
                </div>
                </div>
                ...
                <div class="flex flex-col md:items-end items-center md:pr-4 pr-0 py-2">
                    <span class="bg-[#24C500] text-white text-xs px-4 py-1 rounded-full md:mb-8 mb-3">Completed</span>
                    <a href="#" class="text-[#222222] text-xs flex items-center mt-2 font-semibold">View Job Details
                        <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-2">
                        <path d="M13 4.99982L1 4.99982" stroke="#2B2B2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9.25003 8.75C9.25003 8.75 13 5.98817 13 4.99997C13 4.01177 9.25 1.25 9.25 1.25" stroke="#2B2B2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="flex flex-col md:items-end items-center md:pr-4 pr-0 py-2">
                    <span class="bg-[#FFC600] text-white text-xs px-4 py-1 rounded-full md:mb-8 mb-3">Pending</span>
                    <a href="#" class="text-[#222222] text-xs flex items-center mt-2 font-semibold">View Job Details
                        <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-2">
                        <path d="M13 4.99982L1 4.99982" stroke="#2B2B2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9.25003 8.75C9.25003 8.75 13 5.98817 13 4.99997C13 4.01177 9.25 1.25 9.25 1.25" stroke="#2B2B2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="rounded-xl p-5 bg-white border border-[#22222233]">
            ...
            <div class="space-y-5 h-[600px] overflow-y-auto pr-3">
                ...
                <div class="flex bg-[#FCFCFA] border border-gray-200 rounded-xl shadow-sm">
                    <!-- Left Section -->
                    <div class="flex-1 py-4">
                        <h3 class="text-sm font-bold border-b border-gray-300 pb-2 mb-4 lg:px-4 px-3">
                    ...
                    <!-- Right Arrow Section -->
                    <div class="md:w-24 w-14 flex items-center justify-center border-l border-gray-200">
            ...
            <div class="flex bg-[#FCFCFA] border border-gray-200 rounded-xl shadow-sm">
                ...
                </div><div class="flex bg-[#FCFCFA] border border-gray-200 rounded-xl shadow-sm">
                    <!-- Left Section -->
                    <div class="flex-1 py-4">
                        <h3 class="text-sm font-bold border-b border-gray-300 pb-2 mb-4 lg:px-4 px-3">
                            Job Title: Need To Fix Kitchen Pipe
