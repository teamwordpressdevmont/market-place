                ...
                <table class="genericTable w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b border-[#e9e9e9]">
                            ...
                            <td class="px-6 py-5 whitespace-nowrap text-xs text-mat font-normal">{{ $testimonial->name }}</td>
                            ...
                            <td class="px-6 py-5 whitespace-nowrap text-xs text-mat font-normal">
                                    ...
                                    <div class="site_user_dropdown">
                                        <div class="cursor-pointer w-[30px] ml-auto bg-[#eee] px-1 py-2 rounded-md flex justify-center items-center hover:bg-gray-300 transition" data-dropdown-toggle="userDropdown-action-{{ $testimonial->id }}" data-dropdown-placement="bottom-end">
                                        ...
                                        <div id="userDropdown-action-{{ $testimonial->id }}" class="z-10 bg-white divide-y rounded-xl w-[122px] border border-[#d3d3d3] hidden" data-popper-placement="bottom-end">
                                            <ul class="bg-white text-sm rounded-xl overflow-hidden">
                                                <li class="border-b border-[#d3d3d3]">
                                                    <a href="{{ route('testimonial.edit', $testimonial->id) }}" class="text-left block px-3 py-3 text-xs font-light transition hover:bg-mat hover:text-white text-mat">Edit</a>
                                                </li>
                                                <li class="border-b border-[#d3d3d3]">
                                                    <a href="{{ route('testimonial.view', $testimonial->id) }}" class="text-left block px-3 py-3 text-xs font-light transition hover:bg-mat hover:text-white text-mat">View</a>
                                                </li>
                                                <li class="">
                                                    <a href="{{ route('testimonial.delete', $testimonial->id) }}" class="text-left block px-3 py-3 text-xs font-light transition hover:bg-mat hover:text-white text-mat">Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
