                ...
                <tr class="bg-white border-b border-gray-200">
                    ...
                    <td class="px-6 py-4 font-medium whitespace-nowrap">
                        <form action="{{ route('testimonial.toggleApproval', $testimonial->id) }}" method="POST">
                            @csrf
                            <button type="submit" class="px-4 py-2 text-sm text-white rounded-full {{ $testimonial->approvedTestimonial ? 'bg-red-700 hover:bg-red-800' : 'bg-green-700 hover:bg-green-800' }}">
