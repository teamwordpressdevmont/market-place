                    ...
                    <tr class="bg-white border-b border-gray-200">
                        ...
                        <td class="px-6 py-5 whitespace-nowrap text-xs text-[#222222]">
                            ...
                            <div class="site_user_dropdown">
                                ...
                                <div id="userDropdown-action-{{ $category->id }}" class="-top-[5px]! z-10 bg-white divide-y rounded-xl w-[122px] border border-[#d3d3d3] hidden" data-popper-placement="bottom-end">
