            ...
            <div class="space-y-4">
               ...
               <div class="flex items-center p-4 bg-gray-100 rounded-lg">
                  ...
                  <div class="flex-1">
                     ...
                     <div class="flex items-center text-yellow-500 text-sm"><span class="flex items-center gap-2 text-sm font-bold text-[#2B2B2B] bg-[#F4F3F3] px-4 py-1 rounded-full
                        ">
                        ★ 4.5/5
                        </span><span class="text-gray-500 ml-1">(28 reviews)</span>
                     </div>
                  </div>
