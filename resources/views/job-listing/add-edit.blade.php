                        ...
                        <div class="mt-4">
                            <div id="date-range-picker" date-rangepicker class="flex items-center">
                                <div class="relative w-1/2">
                                    ...
                                    <input id="datepicker-range-start" name="job_start_time" type="text" class="bg-gray-50 border bg-white focus:ring-gray-500 focus:border-gray-500 text-gray-900 text-sm rounded-2xl block w-full ps-10 p-3 datepicker-input" value="{{ old('job_start_time', isset($OrderDetails->job_start_time) ? \Carbon\Carbon::parse($OrderDetails->job_start_time)->format('d-m-Y') : '') }}" placeholder="Select date start">
                                </div>
                                ...
                                <div class="relative w-1/2">
                                    ...
                                    <input id="datepicker-range-end" name="job_end_time" type="text" class="bg-gray-50 border bg-white border-gray-300 focus:ring-gray-500 focus:border-gray-500 text-gray-900 text-sm rounded-2xl block w-full ps-10 p-3 datepicker-input" value="{{ old('job_end_time', isset($OrderDetails->job_end_time) ? \Carbon\Carbon::parse($OrderDetails->job_end_time)->format('d-m-Y') : '') }}" placeholder="Select date end">
                                </div>
                            </div>
                        </div>
                    </div>
