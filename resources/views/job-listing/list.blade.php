...
@section('content')
    ...
    <div class="flex mb-6">
        <h4 class="text-3xl font-bold tracking-tight text-gray-900">Job Listing</h4>
    </div>
    <form id="searchForm" method="GET" action="{{ route('joblisting.list') }}" class="relative mt-1 w-96 mb-5">
