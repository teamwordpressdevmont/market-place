        ...
        <div class="bgShadow pt-15 pb-15">
            <div class="grid grid-cols-2 items-start">
                ...
                <div class="flex justify-end">
                    <a href="#"
                        class="text-white bg-mat hover:bg-primary focus:outline-none  rounded-full text-sm px-20 py-2.5 text-center me-2 mb-2">Reject</a>
                    <a href="#"
                        class="text-white bg-secondary hover:bg-primary focus:outline-none  rounded-full text-sm px-20 py-2.5 text-center me-2 mb-2">Accept</a>
                </div>
        ...
        <div class="">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5">
                <div class="lg:col-span-1 p-">
                    <img src="{{ asset('/images/plumber.png') }}"
                ...
                <div class="lg:col-span-2 p-4">
                    ...
                    <h4 class="font-semibold lg:text-2xl mt-4 mb-2 flex gap-2">
                        ...
                        {{ $OrderDetail->order->tradeperson->last_name }}<svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="text-[#ABABAB] text-xs mb-3 flex leading-none">
                        {{ $OrderDetail->order->tradeperson->categories->pluck('name')->join(', ') }}
                    </p>
                    ...
                    <span class="bg-primary text-white text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">Basic
                        Package</span>
                    ...
                    <div class="swiper mySwiper2">
                                ...
                                <div class="bgShadow pt-10 pb-8">
                                    <div class="grid grid-cols-1 xl:grid-cols-2 lg:gap-8 gap-5 items-end">
                                        <div class="">
                                                ...
                                                <div class="bg-[#FFE9DC] px-3 py-2 rounded-full">
                                                    <svg width="16" height="16" viewBox="0 0 9 9" fill="none"
                                                        ...
                                                        <g clip-path="url(#clip0_490_3278)">
                                                            <ellipse cx="4.27322" cy="4.7875" rx="3.02419"
                                                                ry="3.02419" stroke="#2B2B2B" stroke-width="0.8"
                                                                stroke-linecap="round"></ellipse>
                                                            <path
                                                                d="M1.92107 6.80359L1.24902 7.47563M6.62537 6.80359L7.29741 7.47563"
                                                                stroke="#2B2B2B" stroke-width="0.8" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                            <path
                                                                d="M6.62545 1.61868L6.82555 1.51863C7.10958 1.37661 7.21628 1.39287 7.44209 1.61868C7.66789 1.84449 7.68415 1.95119 7.54214 2.23521L7.44209 2.43531M1.92115 1.61868L1.72105 1.51863C1.43703 1.37661 1.33033 1.39287 1.10452 1.61868C0.878709 1.84449 0.862455 1.95119 1.00447 2.23521L1.10452 2.43531"
                                                                stroke="#2B2B2B" stroke-width="0.8" stroke-linecap="round">
                                                            </path>
                                                            <path d="M4.27344 3.61139V4.95547L4.94548 5.62752"
                                                                stroke="#2B2B2B" stroke-width="0.8" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                            <path d="M4.27344 1.59528V1.09125" stroke="#2B2B2B"
                                                                stroke-width="0.8" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                            <path d="M3.60107 1.09125H4.94516" stroke="#2B2B2B"
                                                                stroke-width="0.8" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                        </g>
                                                        <defs>
                                                            <clipPath id="clip0_490_3278">
                                                                <rect width="8.06452" height="8.06452" fill="white"
                                                                    transform="translate(0.241211 0.419189)"></rect>
                                                            </clipPath>
                                                        </defs>
                                                    </svg>
                                                </div>
                                            ...
                                            <h1 class="text-mat lg:text-4xl md:text-2xl text-xl font-semibold mt-2 mb-2">
                                                Need To Fix Kitchen Pipe</h1>
                                            <p class="text-[#ABABAB] text-xs">Published on: Feb 25, 2025</p>
                                            <div class="mt-4 flex gap-4 items-center">
                                                <h2 class="text-xs font-bold text-mat">Skills</h2>
                                                <span
                                                    class="bg-[#ABABAB] text-white text-gray-700 px-4 py-1 leading[0] rounded-full text-xs hover:bg-secondary transition">Plumber</span>
                                            </div>
                                        </div>
                                        <div
                                            class="flex md:items-end md:gap-12 gap-5 xl:justify-end md:flex-row flex-col items-left">
                                            <a href="#"
                                                class="bg-secondary rounded-full px-4 py-2 text-sm text-white flex items-center justify-between w-40 hover:bg-primary transition">
                                                <svg width="14" height="16" viewBox="0 0 14 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M8.0785 14.2446C7.78937 14.5153 7.40293 14.6666 7.00075 14.6666C6.59856 14.6666 6.21212 14.5153 5.92299 14.2446C3.27535 11.7506 -0.272825 8.96459 1.45751 4.91976C2.39309 2.73275 4.6389 1.33331 7.00075 1.33331C9.36259 1.33331 11.6084 2.73275 12.544 4.91976C14.2721 8.95949 10.7327 11.7592 8.0785 14.2446Z"
                                                        stroke="#DB4A2B"></path>
                                                    <path
                                                        d="M9.33268 7.33333C9.33268 8.622 8.28801 9.66667 6.99935 9.66667C5.71068 9.66667 4.66602 8.622 4.66602 7.33333C4.66602 6.04467 5.71068 5 6.99935 5C8.28801 5 9.33268 6.04467 9.33268 7.33333Z"
                                                        stroke="#DB4A2B"></path>
                                                </svg>
                                        ...
                                        <div
                                            class="w-full max-w-[600px] h-[220px] mx-auto border border-primary rounded-[20px] overflow-hidden p-3 mb-10">
                                            <iframe class="w-full h-full rounded-[10px]"
                        ...
                        <div class="mx-auto max-w-7xlmx-auto hidden">
                            <div class="flex flex-col">
                                <h3
                                    class="mb-5 text-xl text-left font-medium text-white bg-green-900 px-4 py-3 rounded-md">
                                    {{ $OrderDetail->title }}</h3>
                            ...
                            @if (!empty($OrderDetail->order->review))
                                <h4
                                    class="mb-3 text-xl text-left font-medium text-grey border-b pb-3 border-green-700 inline-block">
                                    Order Reviews</h4>
                                <div class="mt-5 mx-auto max-w-7xl bg-white border border-gray-200 shadow-sm mx-auto">
                                    <div class="relative overflow-x-auto">
                                        <table
                                            ...
                                            <tbody>
                                                <tr
                                                    ...
                                                    <td class="px-6 py-4">
                                                        {{ $OrderDetail->order->review->tradeperson->business_name }}</td>
                                                    ...
                                                    <td class="px-6 py-4">
                                                        @if (!empty($OrderDetail->order->review->approved) && $OrderDetail->order->review->approved == 1)
                                                            <span
                                                                class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-red-900 dark:text-red-300">Accepted</span>
                                                        @else
                                                            <a href="{{ route('accept.review', $OrderDetail->order->review->id) }}"
                                                                class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-red-900 dark:text-red-300">Accept</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            </tbody>
