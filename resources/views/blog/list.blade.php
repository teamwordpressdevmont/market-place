    ...
    <div class="mt-5 bgShadow">
        <div class="pt-10 pb-8">
            <div class="grid lg:grid-cols-2 grid-cols-1 items-start mb-8 lg:gap-0 gap-4">
                <h1 class="font-semibold lg:text-4xl md:text-2xl text-xl text-mat">Blog List</h1>
                <a href="{{ route('blog.addEdit') }}" class="lg:ml-auto bg-secondary rounded-full px-4 py-2 text-sm text-white flex items-center justify-between w-fit border border-primary hover:bg-primary transition gap-8">
                    Add New
            ...
            <form id="searchForm" method="GET" action="{{ route('blog.list') }}" class="relative flex md:w-96 w-full mb-8">
                ...
                <table class="genericTable w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 bg-[#eee] border-b border-[#22222233]">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-[#ABABAB] font-[500] whitespace-nowrap">Publish Date</th>
                        ...
                        <tr class="bg-white border-b border-gray-200">
                            ...
                            <td class="px-6 py-5 whitespace-nowrap text-xs font-normal text-[#222222]">
                                ...
                                <div class="site_user_dropdown">
                                    <div class="cursor-pointer w-[30px] ml-auto bg-[#eee] px-1 py-2 rounded-md flex justify-center items-center hover:bg-gray-300 transition" data-dropdown-toggle="userDropdown-action-{{ $blogs->id }}" data-dropdown-placement="bottom-end">
